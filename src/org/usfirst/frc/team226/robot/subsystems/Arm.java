...
public class Arm extends Subsystem {
	...
	public Arm() {
		left.configSelectedFeedbackSensor(FeedbackDevice.CTRE_MagEncoder_Relative, Constants.ARM_PIDSLOT_IDX,
				Constants.ARM_SENSOR_TIMEOUT);
	...
	public void armToPowerBack() {
		heightHolder = Constants.POWER_BACK;
		setArmPos();
	}
	
	public void armToPowerFront() {
		heightHolder = Constants.POWER_FRONT;
		setArmPos();
	}
	...
	public boolean atTarget() {
		return Math.abs(heightHolder - getArmPos()) < Constants.ARM_PID_TOLERANCE;
	}
	...
	/*public boolean isPIDButtonPressed() {
		return Robot.oi.manip.getAButtonPressed() || Robot.oi.manip.getBButtonPressed()
				|| Robot.oi.manip.getYButtonPressed();
	}*/
